...
Install PLR
-----------
1) cd pfff/contrib/plr

2) make

3) make install

4) [INSTALL_DIR]/bin/psql [DB_NAME] < plr.sql

5) [INSTALL_DIR]/bin/psql [DB_NAME] < src/backend/forecast/methods/forecast_functions.sql

...
%type <str> MaintenanceModelGraphStmt
%type <str> opt_number_clause
...
/* orig_tokens */
 ...
 EACH ELSE ENABLE_P ENCODING ENCRYPTED END_P ENUM_P ERRORLIMIT ESCAPE EXCEPT
 ...
 INTERSECT INTERVAL INTERVALP INTO INVOKER IS ISNULL ISOLATION
...
|  CREATE OptTemp TIMESERIES qualified_name '(' OptTableElementList ')' OptInherit OptWith OnCommitOption OptTableSpace
 { 
 $$ = cat_str(11,make_str("create"),$2,make_str("timeseries"),$4,make_str("("),$6,make_str(")"),$8,$9,$10,$11);
}
;
...
|  PRINT NUMBER OF MODEL
 { 
 $$ = make_str("print number of model");
}
;
...
;
 ...
 { 
 $$ = cat_str(10,make_str("create model"),$3,make_str("for forecast of"),$7,make_str("on"),$9,$10,$11,$12,$13);
}
;
...
|  opt_forecast_clause opt_on_clause NUMBER Iconst opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
 { 
 $$ = cat_str(10,$1,$2,make_str("number"),$4,$5,$6,$7,$8,$9,$10);
}
|  opt_forecast_clause opt_on_clause ASOF ecpg_sconst opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
 { 
 $$ = cat_str(10,$1,$2,make_str("asof"),$4,$5,$6,$7,$8,$9,$10);
}
|  opt_forecast_clause opt_on_clause ASOF CURRENT_DATE '+' INTERVAL Iconst granularity_clause opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
 { 
 $$ = cat_str(11,$1,$2,make_str("asof current_date + interval"),$7,$8,$9,$10,$11,$12,$13,$14);
}
;
...
|  CONFIDENCE ecpg_fconst
 { 
 $$ = cat_str(2,make_str("confidence"),$2);
}
| 
 { 
 $$=EMPTY; }
...
;
 ...
 { 
 $$ = make_str("maintenance simplereestimate");
}
|  MAINTENANCE OFF
 { 
 $$ = make_str("maintenance off");
}
|  MAINTENANCE ONDEMAND
 { 
 $$ = make_str("maintenance ondemand");
}
| 
 { 
 $$=EMPTY; }
...
;
 ...
 { 
 $$ = cat_str(2,make_str("maintenance"),$2);
}
;
...
;
 ...
 { 
 $$ = cat_str(8,make_str("fill modelgraph for forecast of"),$6,make_str("on"),$8,$9,$10,$11,$12);
}
;
...
;
 ...
 qualified_name:
 relation_name timeseries_range
 { 
 $$ = cat_str(2,$1,$2);
}
|  relation_name indirection

...
PG_KEYWORD("error", ERRORLIMIT, RESERVED_KEYWORD)
...
PG_KEYWORD("func", FUNC, UNRESERVED_KEYWORD)
...
PG_KEYWORD("pinterval", INTERVALP, RESERVED_KEYWORD)
...
PG_KEYWORD("qcache", QCACHE, RESERVED_KEYWORD)
